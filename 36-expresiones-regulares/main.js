/*
    ...
    Banderas:
        i: ignore case
        No diferencia entre mayusculas y minúsculas
        g: global
        Busca de forma global
        
    Comodines:
        Sustitución:
            > Define un comodín dentro del patron. El símbolo es el "."
        Listado de caracteres válidos:
            > Entre corchetes se pone una lista de los caracteres válidos
            > [aeiou] Con esto cogeríamos todas las vocales
        Rangos:
            > Entre corchetes si ponemos un guión entre dos caracteres establecemos un rango
    ...
    Cantidad:
        Llaves:
            > Lo que está antes tiene que aparecer la cantidad exacta de veces
            > Hay tres combinaciones posibles:
                ...
                ^[a-zA-Z]{1,3}@{1}$
        Asterisco:
            > Lo que está antes del asterisco puede estar,
            puede no estar y se puede repetir.  .*@.*\..*
        Interrogación:
            > Lo que está antes de la interrogación puede no estar,
    ...
    Caracteres:
        \s: Coincide con un carácter de espacio, entre ellos incluidos espacio,
            tab, salto de página, salto de linea. ^[a-zA-Z]+\s[a-zA-Z]+$
